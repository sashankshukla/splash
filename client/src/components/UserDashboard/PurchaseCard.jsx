...
const PurchaseCard = ({ name, id, purchasePrice, currentPrice }) => {
  ...
  return (
    <div className="flex flex-row justify-between items-center w-full h-24 bg-white border-b-2 border-dashed border-gray-200 hover:bg-gray-200 px-8">
      ...
      <div className="flex flex-col text-gray-900 justify-center items-start w-1/4">
        <h1 className="text-md font-bold">$ {purchasePrice}</h1>
        <h1 className="text-sm  text-gray-400">CAD</h1>
      </div>
      <div className="flex flex-col text-gray-900 justify-center items-start w-1/4">
        <h1 className="text-md font-bold">$ {currentPrice}</h1>
        <h1
          className={`text-sm ${
